...
| :---: | :--- | :---: |
| Buscar ID 99 | GET /api/tareas/99 | 409 Conflict. Cuerpo JSON personalizado con mensaje de error sobre el estado.{"status": 404,"message": "Tarea no encontrada con ID: 99", "details": "uri=/api/tareas/99"} |		
